...
SoftwareSerial Bluetooth(19, 17); // Arduino(RX, TX) - HC-05 Bluetooth (TX, RX)

// Define the stepper motors and the pins the will use
AccelStepper LeftBackWheel(1, 51, 53);   // (Type:driver, STEP, DIR) - Stepper1
AccelStepper LeftFrontWheel(1, 43, 45);  // Stepper2
AccelStepper RightBackWheel(1, 33, 35);  // Stepper3
